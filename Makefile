...
OBJ_FILES += $(BUILD_OBJ_PATH)\GlobalProductMarketList.c.o
...
OBJ_FILES += $(BUILD_OBJ_PATH)\LocalProductMarketList.c.o
OBJ_FILES += $(BUILD_OBJ_PATH)\LocalProductMarketMenu.c.o
