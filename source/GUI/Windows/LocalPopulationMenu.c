...
{
	if (nk_begin_titled(platform->ctx, name, "Local Population Menu", nk_rect(50, 50, 250, 250),
		...
		|NK_WINDOW_CLOSABLE|NK_WINDOW_MINIMIZABLE|NK_WINDOW_TITLE))
	{
		...
		{
			addNewPopupWindow(platform->first_window, GOVERNMENT_MENU, getGovernmentByLocation(population->population_centre.location));
		}
